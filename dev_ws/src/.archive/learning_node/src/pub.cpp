...
// TO Publish, you need: 1. header files
...
// TO Publish, you need: 2. a node
class PublisherNode : public rclcpp::Node{
public:
    PublisherNode() : Node("pub_node_name") // ROS2节点父类初始化
    {
        // TO Publish, you need: 3. create an object
...
private:
    ...
    // TO Publish, you need: 4. a pointer
    ...
    void timer_callback()                                                       
    {
        ...
        // TO Publish, you need: 5. publish command
        // 输出日志信息，提示已经完成话题发布   
        pub->publish(msg);                                                
    }
