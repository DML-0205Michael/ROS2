...
#include "msg_pkg/msg/detail/from_arduino_msg__rosidl_typesupport_fastrtps_c.h"
...
using _FromArduinoMsg__ros_msg_type = msg_pkg__msg__FromArduinoMsg;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _FromArduinoMsg__ros_msg_type * ros_message = static_cast<const _FromArduinoMsg__ros_msg_type *>(untyped_ros_message);
  // Field name: ax
  {
    cdr << ros_message->ax;
  }
  ...
  void * untyped_ros_message)
{
  ...
  _FromArduinoMsg__ros_msg_type * ros_message = static_cast<_FromArduinoMsg__ros_msg_type *>(untyped_ros_message);
  // Field name: ax
  {
    cdr >> ros_message->ax;
  }
...
size_t get_serialized_size_msg_pkg__msg__FromArduinoMsg(
  const void * untyped_ros_message,
...
static uint32_t _FromArduinoMsg__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_msg_pkg__msg__FromArduinoMsg(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_msg_pkg
size_t max_serialized_size_msg_pkg__msg__FromArduinoMsg(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_msg_pkg__msg__FromArduinoMsg(
    full_bounded, 0);
}


static message_type_support_callbacks_t __callbacks_FromArduinoMsg = {
  "msg_pkg::msg",
  "FromArduinoMsg",
...
static rosidl_message_type_support_t _FromArduinoMsg__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_FromArduinoMsg,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, msg_pkg, msg, FromArduinoMsg)() {
  return &_FromArduinoMsg__type_support;
}
