...
#include "msg_pkg/srv/detail/test__rosidl_typesupport_fastrtps_c.h"
...
using _Test_Request__ros_msg_type = msg_pkg__srv__Test_Request;
...
size_t get_serialized_size_msg_pkg__srv__Test_Request(
  const void * untyped_ros_message,
...
static uint32_t _Test_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_msg_pkg__srv__Test_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_msg_pkg
size_t max_serialized_size_msg_pkg__srv__Test_Request(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_msg_pkg__srv__Test_Request(
    full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, msg_pkg, srv, Test_Request)() {
...
using _Test_Response__ros_msg_type = msg_pkg__srv__Test_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_msg_pkg
size_t get_serialized_size_msg_pkg__srv__Test_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Test_Response__ros_msg_type * ros_message = static_cast<const _Test_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_msg_pkg__srv__Test_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_msg_pkg
size_t max_serialized_size_msg_pkg__srv__Test_Response(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_msg_pkg__srv__Test_Response(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, msg_pkg, srv, Test_Response)() {
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, msg_pkg, srv, Test)() {
  return &Test__handle;
}
