...
bool msg_pkg__msg__test__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("msg_pkg.msg._test.Test", full_classname_dest, 22) == 0);
  }
  msg_pkg__msg__Test * ros_message = _ros_message;
  {  // ax
...
PyObject * msg_pkg__msg__test__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("msg_pkg.msg._test");
