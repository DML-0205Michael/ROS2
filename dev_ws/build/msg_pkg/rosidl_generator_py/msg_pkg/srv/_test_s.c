...
bool msg_pkg__srv__test__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("msg_pkg.srv._test.Test_Request", full_classname_dest, 30) == 0);
  }
  msg_pkg__srv__Test_Request * ros_message = _ros_message;
  {  // a
...
PyObject * msg_pkg__srv__test__request__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("msg_pkg.srv._test");
...
ROSIDL_GENERATOR_C_EXPORT
bool msg_pkg__srv__test__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("msg_pkg.srv._test.Test_Response", full_classname_dest, 31) == 0);
  }
  msg_pkg__srv__Test_Response * ros_message = _ros_message;
  {  // c
