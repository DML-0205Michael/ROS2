...
static const _Test_Request_type_support_symbol_names_t _Test_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, msg_pkg, srv, Test_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, msg_pkg, srv, Test_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, msg_pkg, srv, Test_Request)() {
  return &::msg_pkg::srv::rosidl_typesupport_c::Test_Request_message_type_support_handle;
}
...
static const _Test_Response_type_support_symbol_names_t _Test_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, msg_pkg, srv, Test_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, msg_pkg, srv, Test_Response)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_msg_pkg
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, msg_pkg, srv, Test_Response)() {
  return &::msg_pkg::srv::rosidl_typesupport_c::Test_Response_message_type_support_handle;
}
...
static const _Test_type_support_symbol_names_t _Test_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, msg_pkg, srv, Test)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, msg_pkg, srv, Test)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, msg_pkg, srv, Test)() {
  return &::msg_pkg::srv::rosidl_typesupport_c::Test_service_type_support_handle;
}
