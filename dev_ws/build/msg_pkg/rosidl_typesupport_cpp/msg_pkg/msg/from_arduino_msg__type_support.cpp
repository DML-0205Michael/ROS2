...
static const _FromArduinoMsg_type_support_symbol_names_t _FromArduinoMsg_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, msg_pkg, msg, FromArduinoMsg)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, msg_pkg, msg, FromArduinoMsg)),
  }
};
...
{
  return &::msg_pkg::msg::rosidl_typesupport_cpp::FromArduinoMsg_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, msg_pkg, msg, FromArduinoMsg)() {
  return get_message_type_support_handle<msg_pkg::msg::FromArduinoMsg>();
}
