...
static const _Test_Request_type_support_symbol_names_t _Test_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, msg_pkg, srv, Test_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, msg_pkg, srv, Test_Request)),
  }
};
...
{
  return &::msg_pkg::srv::rosidl_typesupport_cpp::Test_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, msg_pkg, srv, Test_Request)() {
  return get_message_type_support_handle<msg_pkg::srv::Test_Request>();
}
...
static const _Test_Response_type_support_symbol_names_t _Test_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, msg_pkg, srv, Test_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, msg_pkg, srv, Test_Response)),
  }
};
...
{
  return &::msg_pkg::srv::rosidl_typesupport_cpp::Test_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, msg_pkg, srv, Test_Response)() {
  return get_message_type_support_handle<msg_pkg::srv::Test_Response>();
}
...
static const _Test_type_support_symbol_names_t _Test_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, msg_pkg, srv, Test)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, msg_pkg, srv, Test)),
  }
};
...
{
  return &::msg_pkg::srv::rosidl_typesupport_cpp::Test_service_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_cpp, msg_pkg, srv, Test)() {
  return ::rosidl_typesupport_cpp::get_service_type_support_handle<msg_pkg::srv::Test>();
}
