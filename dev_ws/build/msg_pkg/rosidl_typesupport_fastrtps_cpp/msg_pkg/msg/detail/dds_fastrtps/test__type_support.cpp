...
#include "msg_pkg/msg/detail/test__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const msg_pkg::msg::Test & ros_message,
...
{
  auto typed_message =
    static_cast<const msg_pkg::msg::Test *>(
    untyped_ros_message);
...
{
  return &msg_pkg::msg::typesupport_fastrtps_cpp::_Test__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, msg_pkg, msg, Test)() {
  return &msg_pkg::msg::typesupport_fastrtps_cpp::_Test__handle;
}
