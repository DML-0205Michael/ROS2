...
{
  new (message_memory) msg_pkg::srv::Test_Request(_init);
}

void Test_Request_fini_function(void * message_memory)
{
  auto typed_message = static_cast<msg_pkg::srv::Test_Request *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Test_Request_message_member_array[2] = {
  {
    ...
    offsetof(msg_pkg::srv::Test_Request, a),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(msg_pkg::srv::Test_Request, b),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Test_Request_message_members = {
  "msg_pkg::srv",  // message namespace
  "Test_Request",  // message name
  2,  // number of fields
  sizeof(msg_pkg::srv::Test_Request),
...
{
  return &::msg_pkg::srv::rosidl_typesupport_introspection_cpp::Test_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, msg_pkg, srv, Test_Request)() {
  return &::msg_pkg::srv::rosidl_typesupport_introspection_cpp::Test_Request_message_type_support_handle;
}
...
void Test_Response_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) msg_pkg::srv::Test_Response(_init);
}

void Test_Response_fini_function(void * message_memory)
{
  auto typed_message = static_cast<msg_pkg::srv::Test_Response *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Test_Response_message_member_array[2] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(msg_pkg::srv::Test_Response, c),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(msg_pkg::srv::Test_Response, result),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Test_Response_message_members = {
  ...
  2,  // number of fields
  sizeof(msg_pkg::srv::Test_Response),
...
{
  return &::msg_pkg::srv::rosidl_typesupport_introspection_cpp::Test_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, msg_pkg, srv, Test_Response)() {
  return &::msg_pkg::srv::rosidl_typesupport_introspection_cpp::Test_Response_message_type_support_handle;
}
...
static ::rosidl_typesupport_introspection_cpp::ServiceMembers Test_service_members = {
  "msg_pkg::srv",  // service namespace
  "Test",  // service name
  // these two fields are initialized below on the first access
  // see get_service_type_support_handle<msg_pkg::srv::Test>()
...
get_service_type_support_handle<msg_pkg::srv::Test>()
{
  ...
  auto service_type_support =
    &::msg_pkg::srv::rosidl_typesupport_introspection_cpp::Test_service_type_support_handle;
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, msg_pkg, srv, Test)() {
  return ::rosidl_typesupport_introspection_cpp::get_service_type_support_handle<msg_pkg::srv::Test>();
}
